...
exports.EmailVerification = async (req, res) => {
  try {
    if (req.query.token) {
      ...
      console.log('Received resend request body:', req.body);
      ...
      if (users.length === 0) {
        return res.status(200).json({ 
          message: 'Баталгаажуулах холбоос илгээгдлээ, хэрэв энэ имэйл бүртгэлтэй бол' 
        });
      }
      ...
      return res.status(200).json({ message: 'Баталгаажуулах имэйл илгээгдлээ. Имэйл хаягаа шалгана уу.' });
    }
  } catch (error) {

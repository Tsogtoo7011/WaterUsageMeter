...
export function FeedbackDetails() {
  ...
  const [status, setStatus] = useState('Хүлээгдэж байна');
  ...
  const statusOptions = [
    ...
    { value: 'Хүлээн авахаас татгалзсан', label: 'Хүлээн авахаас татгалзсан' }
  ];
  ...
  const canModifyFeedback = () => {
    ...
    return feedback.Status === 'Хүлээгдэж байна' && 
           Number(user.UserId) === Number(feedback.UserAdminId);
  };
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {feedback.UpdatedAt !== feedback.CreatedAt && (
                      <div>
                        ...
                        <span className="ml-2">{formatDate(feedback.UpdatedAt)}</span>
                      </div>
                    )}
